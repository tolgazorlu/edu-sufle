...
export function WalletInformation() {
    ...
    const {authState: user} = useOCAuth();
                ...
                <div className="md:col-span-2 p-6 md:p-8">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                        <div className="bg-emerald-50 rounded-lg p-4">
                            <div className="text-emerald-600 font-semibold mb-1">{'User'}</div>
                            <div className="text-2xl font-bold text-emerald-700">{user?.OCId || 'Not signed in'}</div>
                        </div>
                        <div className="bg-emerald-50 rounded-lg p-4">
                            ...
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                                ...
                                <div className="mt-2 md:mt-0">
                                    ...
                                    <div className="text-xl font-bold text-teal-800">
                                        {accountBalance} <span className="text-sm">EDU</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {connectedAddress && (
                            <>
                                <Button
                                    ...
                                    onClick={() =>
                                        window.open('https://opencampus-codex.blockscout.com/address/' + connectedAddress, '_blank')
                                    }
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="bg-gradient-to-br from-emerald-600 to-teal-600 p-8 flex flex-col justify-center text-white">
                    ...
                    <ul className="space-y-3">
                        <li className="flex items-center">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="h-5 w-5 mr-2 text-emerald-200"
                                viewBox="0 0 20 20"
                                fill="currentColor"
                            >
                                <path
